...
//
//	/*
//	 * Project 6: Color Picker by Stejara Dinulescu This project is a UI that allows
//	 * the user create a color palette. The user can pick the number of palette
//	 * tiles they would like to see on screen with a slider. The user can also pick
//	 * from a number of options to generate color palettes: "Random" assigns random
//	 * colors to the tiles. "Red", "Blue", and "Green" options allow for tile colors
//	 * to be generated on that specific color scheme. "Selected" allows the user to
//	 * pick a tile that they like for the UI to generate a color palette based on
//	 * the selected tile's color.
//	 */
//
//	PApplet p;
//	ControlP5 cp5;
...
//
//	PaletteTile paletteList[] = new PaletteTile[paletteNum];
//
//	ColorPicker(PApplet p) {
//		this.p = p;
//	}
//
//	void setupPicker() {
...
//			paletteList[i].displayPalette();
//		}
//	}
//
//	void mousePressedPicker() {
//		if (colSwatchType == 4) {
//			counter++;
//			if (counter % 2 == 0) {
//				selected = true;
...
//		}
//		for (int i = 0; i < paletteNum; i++) {
//			paletteList[i].isPressed(selected);
//		}
//	}
//
//	void initCP5() {
...
//					a = p.random(50, 255);
//					// println(r, g, b, a);
//					paletteList[j].c = p.color(r, g, b, a);
//				}
//			}
//		}
//		selected = false;
